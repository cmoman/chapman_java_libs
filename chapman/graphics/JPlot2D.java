...
import chapman.io.*;
/**
 * Class <code>JPlot2D</code> contains methods to plot <i>(x,y)</i> data values.  
 ...
 * The corresponding heavyweight component suitable for use with AWT GUI
 * components is {@link chapman.graphics.Plot2D chapman.graphics.Plot2D}.
 * <p>
 ...
 * <p>
 * Each <code>JPlot2D</code> object can display up to 16 separate curves.
 ...
 * <p>
 * Since this class extends <tt>JComponent</tt>, it can be used with 
 ...
 *
 * @author  S. J. Chapman
 * @version 1.00, 03/21/99
 */

public class JPlot2D extends JComponent
   ...
   private JMenuItem printCanvas, printCanvasDialog; // "Print" item
   ...
   /**
    * This constructor creates a new <tt>JPlot2D</tt> object without initializing
    * the data to be plotted.
    *
    * @see  JPlot2D#JPlot2D(double[])
    * @see  JPlot2D#JPlot2D(double[], int)
    * @see  JPlot2D#JPlot2D(double[],double[])
    * @see  JPlot2D#JPlot2D(double[],double[],int)
    * @see  JPlot2D#JPlot2D(Complex[])
    */
   public JPlot2D() {
      ...
      printCanvas = new JMenuItem("Print");
      printCanvas.addActionListener( this );
      printCanvasDialog = new JMenuItem("Print with Dialog");
   ...
   /**
    * This constructor creates a new <tt>JPlot2D</tt> object with only one
   ...
   /**
    * This constructor creates a new <tt>JPlot2D</tt> object, initializing
   ...
   public void paintComponent(Graphics g) {
      ...
      // If we get here, the data is null, so paint the
      // background only...
      else {
         size = getSize();
   ...
   /**
    * This method sets the plot type.  The possible plot types are JPlot2D.LINEAR,
    * JPlot2D.SEMILOGX, JPlot2D.SEMILOGY, JPlot2D.LOGLOG, and JPlot2D.POLAR.  
    * The default plot type is a linear <i>(x,y)</i> plot.
    *
    * @param  type  Plot type
    *
    * @see  JPlot2D#getPlotType()
    */
   public void setPlotType ( int type ) {
      if ( ( type < JPlot2D.LINEAR ) || ( type > JPlot2D.BAR ) ) {
         String s = "Invalid plot type: " + type;
         throw new IndexOutOfBoundsException(s);
      }
      else if ( type == JPlot2D.LINEAR ) {
         plotType  = type;
         logXAxis  = false;
         logYAxis  = false;
         polarPlot = false;
    ...
    * are JPlot2D.LINEAR, JPlot2D.SEMILOGX, JPlot2D.SEMILOGY, JPlot2D.LOGLOG,
    * and JPlot2D.POLAR.
    *
    * @return an <tt>int</tt> containing the current plot type.
    *
    * @see  JPlot2D#setPlotType(int)
    */
    ...
    * @param  x  Array of x-values to plot
    * @param  y  Array of y-values to plot
    * @see  JPlot2D#setValues(double[],double[],int)
    * @see  JPlot2D#setValues(Complex[])
    * @see  JPlot2D#setValues(Complex[],int)
    */
    ...
    * @param  x  Array of x-values to plot
    * @param  y  Array of y-values to plot
    * @see  JPlot2D#setValues(double[],double[])
    * @see  JPlot2D#setValues(Complex[])
    * @see  JPlot2D#setValues(Complex[],int)
    */
    ...
    *
    * @param  y  Array of y-values to plot
    * @see  JPlot2D#addCurve(double[],double[])
    * @see  JPlot2D#addCurve(Complex[])
    * @see  JPlot2D#setLineStyle(float[])
    * @see  JPlot2D#setLineColor(Color)
    * @see  JPlot2D#setLineWidth(float)
    */
    ...
    * @see  JPlot2D#getPlotY()
    * @see  JPlot2D#setCurrentCurve(int)
    */
    ...
    *
    * @see  JPlot2D#getCurrentCurve()
    * @see  JPlot2D#getTotalCurves()
    */
    ...
    *
    * @see  JPlot2D#getCurrentAnnotation()
    * @see  JPlot2D#getTotalAnnotations()
    */
    ...
    *
    * @see  JPlot2D#getTotalAnnotations()
    * @see  JPlot2D#setCurrentAnnotation(int)
    */
    ...
    *
    * @see  JPlot2D#getBackgroundColor()
    */
    ...
    * @see  JPlot2D#setBackgroundColor(Color)
    */
    ...
    *
    * @see  JPlot2D#getLineStyle()
    * @see  JPlot2D#LINESTYLE_DOT
    * @see  JPlot2D#LINESTYLE_LONGDASH
    * @see  JPlot2D#LINESTYLE_SHORTDASH
    * @see  JPlot2D#LINESTYLE_SOLID
    ...
    *
    * @return a <tt>Color</tt> containing the line color
    * @see  JPlot2D#setFillColor(Color)
    */
    ...
    * @param  s  Plot title.
    *
    * @see  JPlot2D#getTitle()
    * @see  JPlot2D#setXLabel(String)
    * @see  JPlot2D#setYLabel(String)
    */
    ...
    * @see  JPlot2D#getXLabel()
    * @see  JPlot2D#getYLabel()
    * @see  JPlot2D#setTitle(String)
    */
    ...
    *
    * @see  JPlot2D#addAnnotation(String,double,double)
    */
    ...
    * @param  c  A <tt>Color</tt> object
    *
    * @see  JPlot2D#getAnnotationColor()
    */
    ...
    * @see  JPlot2D#setAnnotationColor(Color)
    */
    ...
    *
    * @see  JPlot2D#setAutoXScale()
    * @see  JPlot2D#setYScale(double[])
    */
    ...
    *
    * @see  JPlot2D#setAutoYScale()
    * @see  JPlot2D#setXScale(double[])
    */
    ...
    *
    * @see  JPlot2D#setGridState(boolean)
    */
    ...
    *
    * @see  JPlot2D#getXTics()
    * @see  JPlot2D#setAutoXTics()
    */
